...
#
# 	Note:  The demo ROM does implement SPI, but this demo shows SPI control
# just via the SFR registers
...
#---- SPI SFR constants --------------
spi = {   'SSP1CON1':0xc6, 'SSP1STAT':0xc7, 'SSP1BUF':0xc9, 'LATA':0x89,
	  'ANSELA':0x5b,   'ANSELB':0x5c,   'TRISC':0x94,   'TRISB':0x93, 'TRISA':0x92 }
